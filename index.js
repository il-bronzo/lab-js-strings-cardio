...
/*let ind2= string2.indexOf ("C");
let ind3= string2.indexOf ("O");
let ind4= string2.indexOf ("L");*/
...
const favoriteFruit = fruit.slice(fruit.indexOf("apple"),fruit.indexOf("mango"));
